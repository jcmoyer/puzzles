...
procedure Day06 is
   ...
   type Visited_Map is array (Integer range <>, Integer range <>, Direction range <>) of Boolean;
   ...
   function Simulate_Count_Loops (Map : Char_Matrix; Start : Vec2) return Natural is
      Loops : Natural := 0;
   begin
      for I in Map'Range (1) loop
         for J in Map'Range (2) loop
